...
fn it_is_not_permutation_invariant() {
    ...
    println!("same multiset, two orders: b0 {} vs {}", ordered.beta_0, shuffled.beta_0);
    assert_ne!(ordered.beta_0, shuffled.beta_0,
...
fn it_is_a_sign_change_count_with_a_halving() {
    ...
    for (vals, want) in [
        ...
        assert_eq!(got, want, "pinned sign-change behaviour changed for {vals:?}");
    }
}
...
fn empty_input_returns_perfect_convergence_not_an_empty_space() {
    ...
    assert_eq!((b.beta_0, b.beta_1), (1, 0),
...
fn it_is_not_scale_invariant_in_the_way_a_betti_number_would_be() {
    ...
    println!("magnitudes 1e-12 vs 1e9 -> b0 {} vs {}", small.beta_0, large.beta_0);
    assert_eq!(small.beta_0, large.beta_0,
