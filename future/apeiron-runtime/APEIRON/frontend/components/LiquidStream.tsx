...
// ⚡ Bolt: Extracted and memoized individual message item to prevent O(N^2) renders
// as new messages are added to the stream.
...
export const LiquidStream = () => {
    // ⚡ Bolt: Wrapped initial state in useEffect/setTimeout to prevent server/client hydration mismatch for timestamps,
    // while strictly adhering to the react-hooks/set-state-in-effect rule (must not set state synchronously in effect body).
