...
// Extracting MessageItem and wrapping it in React.memo prevents O(N^2) rendering bottlenecks
// when new chunks are appended to the streaming messages array. We also freeze the timestamp
// using useState so it is not recalculated on every single re-render.
