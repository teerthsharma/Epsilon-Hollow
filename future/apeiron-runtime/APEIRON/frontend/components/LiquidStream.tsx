...
// Wrapped individual messages in React.memo to prevent O(N^2) render bottleneck
// when the input state changes and triggers a full list re-render.
const LiquidStreamMessage = memo(function LiquidStreamMessage({ msg }: { msg: Message }) {
...
export const LiquidStream = () => {
    ...
    return (
        <div className="h-full flex flex-col bg-black relative">
            ...
            >
                {messages.map((msg) => (
                    <LiquidStreamMessage key={msg.id} msg={msg} />
                ))}
