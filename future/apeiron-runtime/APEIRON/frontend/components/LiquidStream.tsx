...
// the full list to re-render.
const MessageItem = memo(function MessageItem({ msg }: { msg: Message }) {
    // ⚡ Bolt: Capture and freeze timestamp on mount to prevent O(N) recalculations
    // and prevent historical messages from updating to the current time on every render.
