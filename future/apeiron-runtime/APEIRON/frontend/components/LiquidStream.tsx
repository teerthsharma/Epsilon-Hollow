...
// Extracting inline message rendering into memoized list item component.
// Wrapping in React.memo() prevents O(N^2) rendering bottlenecks during stream updates.
// Dynamic values like timestamp are moved to state/model so they don't re-render with new values.
