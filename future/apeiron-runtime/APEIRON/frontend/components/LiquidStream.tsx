...
// Without this, every new message added to the state array triggers a full re-render
// of all previous messages. We also freeze the timestamp in the Message data model
// so it doesn't recalculate on every render.
