...
// Wrapped message rendering in React.memo to prevent O(N^2) full-list re-renders
// when new messages are added to the stream. Froze the timestamp via useState
// to prevent recalculation on each render.
