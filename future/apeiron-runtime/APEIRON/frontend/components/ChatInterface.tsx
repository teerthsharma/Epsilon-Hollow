                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            className="flex-1 bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:border-transparent transition-colors text-white"
                        />
                        <button
                            type="submit"
                            disabled={!input.trim()}
                            ...
                            className="p-3 bg-gray-800 hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg text-green-500 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
                        >
                            <Send size={20} />
                        </button>
                    </form>
