                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            placeholder={tunnelStatus !== 'LOCKED' ? "Connecting to kernel..." : "Inject knowledge into the kernel..."}
                        ...
                        <button
                            ...
                            aria-label={tunnelStatus !== 'LOCKED' ? "Disconnected from kernel" : (!input.trim() ? "Cannot send empty message" : "Send message")}
                            title={tunnelStatus !== 'LOCKED' ? "Disconnected from kernel" : (!input.trim() ? "Enter a message to send" : "Send message")}
