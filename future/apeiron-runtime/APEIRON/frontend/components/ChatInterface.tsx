...
export default function ChatInterface() {
    ...
    // ⚡ Bolt: Performance optimization
    // Extract array mappings into useMemo to prevent O(N) recalculations
    // on every render when high-frequency telemetry updates state (like pulseType/isLearning).
