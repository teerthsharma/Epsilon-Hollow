...
// Memoized subcomponent to prevent O(N^2) re-renders during array streaming
...
// Memoized subcomponent to prevent O(N^2) re-renders during array streaming
const MessageItem = memo(function MessageItem({ msg }: { msg: { id: string, sender: 'user' | 'apeiron', text: string, isPlasticityEvent: boolean } }) {
    return (
