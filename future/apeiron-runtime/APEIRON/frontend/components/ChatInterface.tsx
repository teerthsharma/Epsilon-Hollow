...
export default function ChatInterface() {
    ...
    // ⚡ Bolt: Performance optimization
    // Memoize the rendered array mappings to prevent O(N) array mapping on every re-render
    // caused by frequent unrelated state changes (e.g. pulseType animation or isLearning state)
