                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            placeholder={tunnelStatus === 'LOCKED' ? "Inject knowledge into the kernel..." : "System offline. Awaiting neuro-link..."}
                        ...
                        <button
                            ...
                            title={tunnelStatus !== 'LOCKED' ? "System is offline" : (!input.trim() ? "Enter a message to send" : "Send message")}
