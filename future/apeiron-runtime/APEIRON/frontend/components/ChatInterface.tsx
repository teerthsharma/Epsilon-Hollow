...
// Memoized components to prevent O(N^2) rendering bottlenecks on streamed chunks
const MemoizedThought = React.memo(function MemoizedThought({ t }: { t: string }) {
    return (
...
const MemoizedMessage = React.memo(function MemoizedMessage({ msg }: { msg: { id: string, sender: string, text: string, isPlasticityEvent: boolean } }) {
    return (
