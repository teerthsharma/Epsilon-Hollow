...
// Memoize individual thought items to avoid full re-renders on the thought stream.
...
// Memoize individual chat messages to prevent O(N^2) rendering bottlenecks caused by state array updates during streaming.
