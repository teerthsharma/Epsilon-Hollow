                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            placeholder={tunnelStatus !== 'LOCKED' ? "Waiting for neuro-link..." : "Inject knowledge into the kernel..."}
                        ...
                        <button
                            ...
                            aria-label={tunnelStatus !== 'LOCKED' ? "Neuro-link offline" : !input.trim() ? "Cannot send empty message" : "Send message"}
