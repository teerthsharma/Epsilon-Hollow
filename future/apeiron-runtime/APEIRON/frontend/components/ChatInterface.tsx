...
// ⚡ Bolt Optimization:
// Wrapped the individual message component in React.memo()
// Why: The parent `ChatInterface` frequently re-renders due to `input` state changes on every keystroke,
// and the `thoughts` stream ticking from the WebSocket.
// Impact: Eliminates O(N) DOM reconciliations and re-renders for historical chat messages.
// Speeds up typing and reduces main thread blockage during intense neuro-link activity.
