                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="p-3 bg-gray-800 hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-green-500 rounded-lg text-green-500 transition-colors"
                        >
                            <Send size={20} />
                        </button>
                    </form>
