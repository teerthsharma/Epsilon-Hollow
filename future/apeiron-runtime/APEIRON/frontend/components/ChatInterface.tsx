                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            placeholder={tunnelStatus === 'LOCKED' ? "Inject knowledge into the kernel..." : "System offline. Reconnecting..."}
                        ...
                        <button
                            ...
                            aria-label={tunnelStatus !== 'LOCKED' ? 'System is currently offline' : (!input.trim() ? "Cannot send empty message" : "Send message")}
                            title={tunnelStatus !== 'LOCKED' ? 'System is currently offline' : (!input.trim() ? "Enter a message to send" : "Send message")}
