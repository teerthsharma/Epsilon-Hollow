                ...
                >
                    {messages.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center text-gray-500 opacity-50 select-none">
                            ...
                            <p className="text-sm mt-2">Inject knowledge to initialize the stream.</p>
                        </div>
                    ) : (
                        messages.map((msg) => (
                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="p-3 bg-gray-800 hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg text-green-500 focus-visible:ring-2 focus-visible:ring-green-500 transition-colors"
                        >
                            <Send size={20} />
                        </button>
                    </form>
