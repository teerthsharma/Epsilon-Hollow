...
// ⚡ Bolt: Extracted ChatMessageItem and wrapped with React.memo()
// This prevents O(N^2) rendering bottlenecks by ensuring individual message
// components don't re-render when new messages are added to the stream.
