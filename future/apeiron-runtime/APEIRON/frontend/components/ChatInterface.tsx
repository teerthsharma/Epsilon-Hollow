                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            aria-label={tunnelStatus !== 'LOCKED' ? "Message input (Offline)" : "Message input"}
                        ...
                        <button
                            ...
                            title={tunnelStatus !== 'LOCKED' ? "Neuro-link offline" : !input.trim() ? "Enter a message to send" : "Send message"}
