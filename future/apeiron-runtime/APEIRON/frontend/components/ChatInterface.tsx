                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        ...
                        <button
                            ...
                            aria-label={tunnelStatus !== 'LOCKED' ? "Kernel disconnected" : (!input.trim() ? "Cannot send empty message" : "Send message")}
                            title={tunnelStatus !== 'LOCKED' ? "Waiting for connection..." : (!input.trim() ? "Enter a message to send" : "Send message")}
