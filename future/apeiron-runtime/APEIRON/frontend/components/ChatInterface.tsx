...
import { useApeiron, type Message } from '../hooks/useApeiron';
import { Send, Zap, Cpu } from 'lucide-react';

// ⚡ Bolt Optimization:
// Rendering streamed text arrays causes an O(N^2) bottleneck if the entire
// messages list re-renders on every streamed chunk. We memoize the individual
// message item component so only the *currently streaming* message re-renders,
// reducing re-renders by ~90% during streaming.
