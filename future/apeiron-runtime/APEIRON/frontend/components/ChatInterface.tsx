...
// ⚡ Bolt: Extracted ChatMessage and wrapped in React.memo to prevent O(N^2)
// re-renders on the entire message list when receiving streaming chunks.
const ChatMessage = React.memo(({ msg }: { msg: { id: string; sender: 'user' | 'apeiron'; text: string; isPlasticityEvent: boolean } }) => (
