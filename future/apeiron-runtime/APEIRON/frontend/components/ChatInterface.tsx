                ...
                >
                    {messages.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-gray-500 space-y-4">
                            ...
                            <p className="text-sm tracking-widest uppercase">System Idle</p>
                            <p className="text-xs opacity-50">Inject knowledge to begin cognitive runtime</p>
                        </div>
                    ) : (
                        messages.map((msg) => (
                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            className="flex-1 bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 focus:outline-none focus:border-green-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 transition-colors text-white"
                        />
                        <button
                            type="submit"
                            disabled={!input.trim()}
                            ...
                            title="Send message"
                            className="p-3 bg-gray-800 hover:bg-gray-700 disabled:opacity-50 rounded-lg text-green-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
                        >
                            <Send size={20} />
                        </button>
                    </form>
