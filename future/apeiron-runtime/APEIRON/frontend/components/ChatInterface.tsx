                ...
                >
                    {messages.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center text-gray-500 space-y-4">
                            ...
                            <p className="text-sm tracking-widest uppercase">Kernel initialized. Awaiting knowledge injection...</p>
                        </div>
                    ) : (
                        messages.map((msg) => (
                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        ...
                        <button
                            ...
                            title="Send message"
                            className="p-3 bg-gray-800 hover:bg-gray-700 disabled:opacity-50 rounded-lg text-green-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 transition-colors"
                        >
                            <Send size={20} />
                        </button>
                    </form>
