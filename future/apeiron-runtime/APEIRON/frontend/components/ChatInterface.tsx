                ...
                <div className="p-6 border-t border-gray-800 bg-black">
                    ...
                    >
                        <input
                            ...
                            placeholder={tunnelStatus !== 'LOCKED' ? "Downlink offline..." : "Inject knowledge into the kernel..."}
                            aria-label={tunnelStatus !== 'LOCKED' ? "Input disabled while offline" : "Message input"}
