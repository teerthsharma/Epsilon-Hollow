...
export default function ChatInterface() {
    ...
    // ⚡ Bolt: Performance optimization
    // Even though MessageItem and ThoughtItem are memoized, mapping over large arrays
    // directly in the render function incurs O(N) overhead on every single re-render.
    // Since ChatInterface re-renders frequently due to unrelated state changes
    // (like streaming telemetry/pulseType), memoizing the array mapping prevents this overhead.
