...
export default function ConsolePanel() {
  // ⚡ Bolt: Extract Zustand Selectors. Using individual selectors instead of destructuring
  // the full store prevents the component from re-rendering on unrelated state updates.
  ...
  // ⚡ Bolt: Extract Map Operations from Render Loop. Wrapping the array mapping logic
  // in useMemo prevents the O(N) operation from running on unrelated re-renders.
