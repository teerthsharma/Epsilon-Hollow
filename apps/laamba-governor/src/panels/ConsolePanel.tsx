...
// ⚡ Bolt: Memoize log items to prevent O(N^2) re-rendering of the entire list
// when new logs are appended to the frequently updated `logs` array state.
const LogItem = React.memo(function LogItem({ log }: { log: string }) {
  return (
    <div
      className={
