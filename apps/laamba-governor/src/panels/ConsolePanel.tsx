  ...
  return (
    <div className="h-32 bg-gov-panel border-t border-gov-border flex flex-col shrink-0">
      <div className="h-6 flex items-center px-3 gap-2 text-[10px] uppercase tracking-wider text-gov-dim border-b border-gov-border">
        ...
        <button onClick={clearLogs} className="hover:text-gov-accent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gov-accent rounded" aria-label="Clear logs" title="Clear logs">
          <Trash2 size={10} />
        </button>
      </div>
