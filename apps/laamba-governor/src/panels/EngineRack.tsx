...
export default function EngineRack() {
  ...
  const { activeEngine, setActiveEngine, selectedDataset, selectDataset, addLog, setAnalysisResult, setEngineResult, addExperiment, updateExperiment  } = useStore(useShallow(s => ({
