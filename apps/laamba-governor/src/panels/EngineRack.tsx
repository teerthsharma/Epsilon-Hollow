...
export default function EngineRack() {
  ...
  const { activeEngine, setActiveEngine, selectedDataset, selectDataset, addLog, setAnalysisResult, setEngineResult, addExperiment, updateExperiment } = useStore(useShallow((s) => ({ activeEngine: s.activeEngine, setActiveEngine: s.setActiveEngine, selectedDataset: s.selectedDataset, selectDataset: s.selectDataset, addLog: s.addLog, setAnalysisResult: s.setAnalysisResult, setEngineResult: s.setEngineResult, addExperiment: s.addExperiment, updateExperiment: s.updateExperiment })));
