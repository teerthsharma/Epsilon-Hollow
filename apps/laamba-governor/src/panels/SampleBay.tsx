...
import { useStore, type AppStore, type Dataset } from "../store";
...
export default function SampleBay() {
  ...
  const { datasets, selectedDataset, selectDataset, setVitalsResult, addLog, setDatasets } = useStore(useShallow((s: AppStore) => ({
    datasets: s.datasets,
