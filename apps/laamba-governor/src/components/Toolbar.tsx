...
export default function Toolbar() {
  const { selectedDataset, isRunning, setRunning, addLog, setBattleResult, setAnalysisResult, setRankResult, setRegressResult, setClassifyResult, addExperiment, updateExperiment } = useStore(useShallow((s) => ({ selectedDataset: s.selectedDataset, isRunning: s.isRunning, setRunning: s.setRunning, addLog: s.addLog, setBattleResult: s.setBattleResult, setAnalysisResult: s.setAnalysisResult, setRankResult: s.setRankResult, setRegressResult: s.setRegressResult, setClassifyResult: s.setClassifyResult, addExperiment: s.addExperiment, updateExperiment: s.updateExperiment })));
