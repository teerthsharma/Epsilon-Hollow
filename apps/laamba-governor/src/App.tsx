...
export default function App() {
  // ⚡ Bolt: Extract Zustand selectors individually to prevent unnecessary re-renders
  // of the entire application tree whenever unrelated state (like logs) changes.
