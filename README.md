...
| **Package Manager** | Local `.eph` parse/install/extract/list/remove is boot-gated by `[ManifoldPkg] proof` with `signature=ed25519_fixture`; the boot fixture is signed and verified before install. Remote registry index and public signed release channel are still pending. | Build remote registry index + release fixture gate |
...
**116201 lines of Rust** across 388 files | 0 lines of x86 assembly | 1823 lines of Aether-Lang DSL | **118024 total**
<!-- RUST_LINE_COUNT_END -->
